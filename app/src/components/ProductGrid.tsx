    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
        {Array.from({ length: 9 }).map((_, index) => (
          <div
            key={index}
            className="bg-white dark:bg-carbon-800 border border-slate-200 dark:border-carbon-600/30 rounded-2xl overflow-hidden animate-pulse"
          >
            <div className="h-48 bg-slate-100 dark:bg-carbon-700"></div>
            <div className="p-4 space-y-3">
              <div className="flex gap-2">
                <div className="h-3 w-16 bg-slate-200 dark:bg-carbon-700 rounded"></div>
                <div className="h-3 w-12 bg-slate-200 dark:bg-carbon-700 rounded"></div>
              </div>
              <div className="h-4 w-full bg-slate-200 dark:bg-carbon-700 rounded"></div>
              <div className="h-4 w-3/4 bg-slate-200 dark:bg-carbon-700 rounded"></div>
              <div className="flex gap-2 pt-2">
                <div className="h-5 w-16 bg-slate-200 dark:bg-carbon-700 rounded"></div>
                <div className="h-5 w-16 bg-slate-200 dark:bg-carbon-700 rounded"></div>
              </div>
              <div className="border-t border-slate-100 dark:border-carbon-600/30 pt-3 mt-3">
                <div className="h-6 w-24 bg-slate-200 dark:bg-carbon-700 rounded"></div>
                <div className="h-3 w-32 bg-slate-200 dark:bg-carbon-700 rounded mt-2"></div>
              </div>
            </div>
          </div>
        ))}
